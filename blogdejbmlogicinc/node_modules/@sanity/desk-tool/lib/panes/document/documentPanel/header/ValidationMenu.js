...
function ValidationMenu(props) {
  ...
  if (validationErrorMarkers.length === 0 && validationWarningMarkers.length === 0 && validationInfoMarkers.length === 0) {
    return null;
  }

  var popoverContent = /*#__PURE__*/_react.default.createElement(_components.ValidationList, {
